...
class Matrix {
    ...
    private:
        ...
        std::vector<GLfloat*> m_oArrayLinks;
    ...
    public:
        ...
        //  .   .   .
        // 12 - 13 - 14 -15
        static const enum TEXTURE_COORDS {
        ...
        ~Matrix() {
            ...
            std::for_each(m_oArrayLinks.begin(), m_oArrayLinks.end(), [] (std::vector<GLfloat*>::value_type &item) {
                delete [] item;
            });
        ...
        GLfloat * getDefaultMatrix4x4() {
            ...
            m_oArrayLinks.push_back(matrix);
        ...
        GLfloat * getDefaultTextureCoord() {
            ...
            m_oArrayLinks.push_back(texture);
        ...
        GLfloat * getDefaultVerticesCoords() {
            ...
            m_oArrayLinks.push_back(vertices);
